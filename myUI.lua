...
local v0_sec1 = v0:AddSection({
    Title = "Quantum HUB Overview",
    Open = true
})

v0_sec1:AddParagraph({
    Title = "Quantum HUB | Blox Fruits",
    Content = "Selamat datang di Quantum HUB! Script multi-fitur berkecepatan tinggi dengan antarmuka modern Fluent NewEra untuk pengalaman farming & PvP terbaik di Blox Fruits."
})

v0_sec1:AddParagraph({
    Title = "Developer & Credits",
    Content = "• Developed by: Quantum
• Team: Quantum Team
• Version: 1.0.0.1 (Premium Release)
• Supported Seas: Sea 1, Sea 2, Sea 3"
})

v0_sec1:AddParagraph({
    Title = "System Status",
    Content = "• Status: Operational & Undetected
• UI Framework: NewEra Fluent V2
• Active Features: Farm, Sea Events, Raids, V4, ESP, Teleport, Combat"
})

local v0_sec2 = v0:AddSection({
...
local Timmessss = v1_sec1:AddParagraph({
    Title = "Time",
    Content = ""
})
function UpdateTime()
...
local Kitsunecheck = v1_sec2:AddParagraph({
...
local CPrehistoriccheck = v1_sec2:AddParagraph({
...
local FrozenIsland = v1_sec2:AddParagraph({
...
local MobCakePrince = v1_sec2:AddParagraph({
...
local TyrantStatus = v1_sec2:AddParagraph({
...
local CheckRip = v1_sec2:AddParagraph({
    Title = "Rip_Indra",
    Content = "Status: "
})
spawn(function()
...
local CheckDoughKing = v1_sec2:AddParagraph({
    Title = "Dough King",
    Content = "Status: "
})
spawn(function()
...
local EliteHunter = v1_sec2:AddParagraph({
    Title = "Elite Hunter",
    Content = "Status: "
})
spawn(function()
...
local Pullever = v1_sec2:AddParagraph({
    Title = "Pull Lever",
    Content = "Status: "
})
spawn(function()
...
local LegendarySword = v1_sec2:AddParagraph({
...
local Bone = v1_sec2:AddParagraph({
    Title = "Bone",
    Content = ""
})
spawn(function()
...
v4_sec1:AddToggle("EnableFastAttack", {
...
v4_sec1:AddToggle("EnableAutoClick", {
...
v4_sec1:AddDropdown("Selecttargettype", {
...
v4_sec1:AddToggle("Autoclickwhenholdinggun2s", {
...
local targetDisplay = v4_sec1:AddParagraph({
...
local v2_sec1 = v2:AddSection({
    Title = "Auto Farm main",
    Open = true
})
v2_sec1:AddDropdown("SelectWeapon", {
    Title = "Select Weapon",
...
v2_sec1:AddDropdown("SelectFarmMode", {
...
v2_sec1:AddToggle("AcceptQuests", {
    Title = "Accept Quests",
...
v2_sec2:AddToggle("KillMobsNearest", {
...
if World2 then
v2_sec2:AddToggle("AutoFactoryRaid", {
...
if World3 then
v2_sec2:AddToggle("AutoPirateRaid", {
...
local v2_sec3 = v2:AddSection({
    Title = "Collect",
    Open = true
})

v2_sec3:AddToggle("AutoCollectChest", {
...
v2_sec3:AddToggle("AutoCollectBerry", {
...
local v2_sec4 = v2:AddSection({
    Title = "Material",
    Open = true
})

v2_sec4:AddDropdown("SelectMaterial", {
...
if World3 then
local v2_sec5 = v2:AddSection({
    Title = "Bones",
    Open = true
})

v2_sec5:AddToggle("TradeBone", {
    Title = "Trade Bone",
    Default = false,
    Callback = function(Value)
        _G.Rdbone = Value
...
v2_sec5:AddToggle("AutoSoulReaper", {
...
local v2_sec6 = v2:AddSection({
    Title = "Boss Farm",
    Open = true
})

local BossStatus = v2_sec6:AddParagraph({
...
local BossDropdown = v2_sec6:AddDropdown("SelectBoss", {
    Title = "Select Boss",
    Values = Boss,
...
v2_sec6:AddToggle("AutoFarmBossSelect", {
...
v2_sec6:AddToggle("AcceptQuestBoss", {
...
v2_sec6:AddToggle("FarmAllBosses", {
...
v2_sec7:AddDropdown("SelectIslandForMastery", {
...
v2_sec7:AddToggle("AutoFarmMasteryFruit", {
...
v2_sec7:AddToggle("UseSkillZFruit", { Title = "Use Skill Z (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.Z = v end })
v2_sec7:AddToggle("UseSkillXFruit", { Title = "Use Skill X (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.X = v end })
v2_sec7:AddToggle("UseSkillCFruit", { Title = "Use Skill C (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.C = v end })
v2_sec7:AddToggle("UseSkillVFruit", { Title = "Use Skill V (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.V = v end })
v2_sec7:AddToggle("UseSkillFFruit", { Title = "Use Skill F (Fruit)", Default = false, Callback = function(v) _G.FruitSkills.F = v end })
...
v2_sec7:AddToggle("AutoFarmMasteryGun", {
...
v2_sec7:AddToggle("AutoFarmMasteryAllSword", {
...
v4_sec1:AddToggle("AutoActiveHaki", {
...
v4_sec1:AddToggle("AutoActiveV3", {
...
v4_sec1:AddToggle("AutoActiveV4", {
...
v4_sec1:AddToggle("DisableNotify", {
...
v4_sec2:AddInput("SelectFarmHeight", {
    Finished = true,
...
v4_sec2:AddToggle("AutoHopkhiAdminJoin", {
...
local v4_sec3 = v4:AddSection({
    Title = "Auto Hop",
    Open = true
})

v4_sec3:AddToggle("AutoHopServer", {
...
v4_sec3:AddSlider("HopDelayMinutes", {
...
v5_sec1:AddDropdown("SelectFishingRod", {
...
v5_sec1:AddDropdown("SelectBait", {
    Title = "Select Bait",
    Values = {
        "Basic Bait",
        "Kelp Bait",
...
if World1 then
    local v3_sec1 = v3:AddSection({
        Title = "Travel To Sea 2",
        Open = true
    })

    local TravelDresToggle = v3_sec1:AddToggle("AutoQuestSea2", {
...
if World2 then
    local v3_sec2 = v3:AddSection({
        Title = "Travel To Sea 3",
        Open = true
    })

    local AutoZouToggle = v3_sec2:AddToggle("AutoQuestSea3", {
...
v5_sec1:AddToggle("AutoQuestFishing", {
...
v5_sec1:AddToggle("AutoCompleteQuest", {
...
v5_sec1:AddToggle("AutoSellFish", {
...
v5_sec1:AddToggle("Autouseskilloftherod", {
...
local v3_sec3 = v3:AddSection({
    Title = "Quests",
    Open = true
})

v3_sec3:AddToggle("AutoFarmObservation", {
...
if World3 then
    v3_sec3:AddToggle("AutoObservationV2", {
    ...
    v3_sec3:AddToggle("AutoCitizenQuest", {
    ...
    local v3_sec4 = v3:AddSection({
        Title = "Cursed Swords",
        Open = true
    })

    local EliteProgressPara = v3_sec4:AddParagraph({ Title = "Elites Process ", Content = "" });
    spawn(function()
        while wait(Sec) do
            pcall(function()
    ...
    v3_sec4:AddToggle("AutoEliteQuest", {
    ...
    v3_sec4:AddToggle("StopwhengotGodsChalice", {
    ...
    v3_sec4:AddToggle("AutoTushitaSword", {
    ...
    v3_sec4:AddToggle("AutoYamaSword", {
...
if World2 or World3 then
    local v3_sec5 = v3:AddSection({
        Title = "Buso/Aura Colours",
        Open = true
    })

    v3_sec5:AddToggle("TeleportBaristaHaki", {
...
if World3 then
    v3_sec5:AddToggle("AutoRainbowHaki", {
...
v3_sec5:AddToggle("AcceptQuestBypassRisk", {
...
local v3_sec6 = v3:AddSection({
    Title = "Item",
    Open = true
})
if World2 then

    v3_sec6:AddToggle("AutoDragonTrident", {
...
if World1 then
    v3_sec6:AddToggle("AutoSawSword", {
...
if World2 then
    v3_sec6:AddToggle("AutoSwanCoat", {
...
if World1 then
    v3_sec6:AddToggle("AutoMarineCoat", {
...
if World1 then
    v3_sec6:AddToggle("AutoWardenSword", {
...
if World1 then
    v3_sec6:AddToggle("AutoCyborgSword", {
...
if World2 then
    v3_sec6:AddToggle("AutoMidnightBlade", {
...
if World2 then
    v3_sec6:AddToggle("AutoRengokuSword", {
    ...
    v3_sec6:AddToggle("AutoRengokuKey", {
...
if World2 or World3 then
    v3_sec6:AddToggle("AutoPoleV2Beta", {
...
if World1 then
    v3_sec6:AddToggle("AutoBisentoV2", {
...
if World3 then
    v3_sec6:AddToggle("AutoSkullGuitar", {
    ...
    local SoulGuitarStatus = v3_sec6:AddParagraph({
...
if World3 then
    local v3_sec7 = v3:AddSection({
        Title = "Cursed Dual Katana (CDK)",
        Open = true
    })

    local CDKProgress = v3_sec7:AddParagraph({
        Title = "CDK Progress",
    ...
    v3_sec7:AddToggle("AutoTushitaCDK", {
    ...
    v3_sec7:AddToggle("AutoKillCursedSkeletonBoss", {
...
if World3 then
    ...
    v3_sec8:AddToggle("TeleporttoLegendarySwordDealer", {
...
if World2 then
    v3_sec8:AddToggle("AutoSwanGlasses", {
...
if World3 then
    v3_sec8:AddToggle("AutoCanvendishSword", {
...
if World3 then
    v3_sec8:AddToggle("AutoBigmomCakeQueen", {
...
if World3 then
    v3_sec8:AddToggle("AutoTrainingDummy", {
...
v6_sec1:AddDropdown("SelectBoats", {
        Title = "Select Boats",
        Values = BoatList,
        Default = "Guardian",
        Multi = false,
...
if World3 then
        ...
        v6_sec1:AddDropdown("SelectLevelSea", {
...
v6_sec1:AddToggle("AutoPressWAutoDrive", {
...
v6_sec1:AddToggle("ActivateBoatSpeed", {
...
v6_sec1:AddInput("BoatSpeedValue", {
    Finished = true,
...
v6_sec1:AddToggle("AutoStartfarm", {
...
local v6_sec2 = v6:AddSection({
    Title = "Select what you will farm",
    Open = true
})

v6_sec2:AddToggle("AutoAttackSeaBeast", {
...
v6_sec2:AddToggle("AutoAttackPirateGrandBrigade", {
...
if World2 then
    local v6_sec3 = v6:AddSection({
        Title = "Go to Sea 3 for more options",
        Open = true
    })
end
if World1 then
    local v6_sec4 = v6:AddSection({
        Title = "Go to Sea 3 or Sea 2 for Farm maritime events",
        Open = true
    })
end
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
    v6_sec4:AddToggle("AutoShark", {
        Title = "Auto Shark",
        Default = false,
        Callback = function(Value)
            _G.Shark = Value
    ...
    v6_sec4:AddToggle("AutoTerrorShark", {
    ...
    v6_sec4:AddToggle("AutoFishCrewMember", {
    ...
    v6_sec4:AddToggle("AutoHauntedCrewMember", {
    ...
    v6_sec4:AddToggle("AutoAttackFishBoat", {
...
if game.PlaceId == 7449423635 or game.PlaceId == 100117331123089 then
    ...
    v6_sec5:AddToggle("TeleportFrozenDimension", {
    ...
    v6_sec5:AddToggle("AutoAttackLeviathan", {
    ...
    local v6_sec6 = v6:AddSection({
        Title = "Kitsune Island / Event",
        Open = true
    })

    v6_sec6:AddToggle("AutoFindKitsuneIsland", {
    ...
    v6_sec6:AddToggle("AutoTeleporttoShrineActived", {
    ...
    v6_sec6:AddToggle("AutoCollectAzureEmber", {
    ...
    v6_sec6:AddToggle("AutoTradeAzureEmber", {
...
local v7_sec1 = v7:AddSection({
    Title = "Prehistoric Island",
    Open = true
})

local PrehistoricStatus = v7_sec1:AddParagraph({
...
local v7_sec2 = v7:AddSection({
    Title = "Skill Selection (Prehistoric)",
    Open = true
})
...
v7_sec2:AddToggle("PrehistoricMeleeZ", {
...
v7_sec2:AddToggle("PrehistoricMeleeX", {
...
v7_sec2:AddToggle("PrehistoricMeleeC", {
...
v7_sec2:AddToggle("PrehistoricSwordZ", {
...
v7_sec2:AddToggle("PrehistoricSwordX", {
...
v7_sec2:AddToggle("PrehistoricFruitZ", {
...
v7_sec2:AddToggle("PrehistoricFruitX", {
...
v7_sec2:AddToggle("PrehistoricFruitC", {
...
v7_sec2:AddToggle("PrehistoricFruitV", {
...
v7_sec2:AddToggle("PrehistoricFruitF", {
...
v7_sec2:AddToggle("PrehistoricGunZ", {
...
v7_sec2:AddToggle("PrehistoricGunX", {
...
local v7_sec3 = v7:AddSection({
    Title = "Main Prehistoric Options",
    Open = true
})

v7_sec3:AddToggle("AutoFindPrehistoricIsland", {
...
v7_sec3:AddToggle("AutoStartPrehistoricEvent", {
...
v7_sec3:AddToggle("AutoPatchRemoveLava", {
...
local KillAuraDisplay = v7_sec3:AddParagraph({
...
v7_sec3:AddToggle("AutoKillLavaGolem", {
...
v7_sec3:AddToggle("AutoCollectDinoBones", {
...
v7_sec3:AddToggle("AutoCollectDragonEggs", {
...
local v7_sec4 = v7:AddSection({
    Title = "Volcanic Crafting",
    Open = true
})
...
v7_sec4:AddToggle("AutoCraftVolcanicMagnet", {
...
local v7_sec5 = v7:AddSection({
    Title = "Drago Trials",
    Open = true
})

v7_sec5:AddToggle("TweenToUpgradeDragoTrial", {
...
v7_sec5:AddToggle("AutoDragoV1GetDragonEgg", {
...
v7_sec5:AddToggle("AutoDragoV2FireFlowers", {
...
v7_sec5:AddToggle("AutoDragoV3TerrorSharkSeaBeast", {
...
v7_sec5:AddToggle("AutoRelicDragoTrialBeta", {
...
v7_sec5:AddToggle("AutoTrainDragov4", {
...
v7_sec5:AddToggle("TweentoDragoTrialsInsideVolcano", {
...
v7_sec5:AddToggle("SwapDragoRaceBuy", {
...
v7_sec5:AddToggle("UpgradeDragonTalonWithUzoth", {
...
v7_sec6:AddToggle("AutoDojoTrainerCompleteQuests", {
...
v7_sec6:AddToggle("AutoDragonHunterHydraVenomous", {
...
local v8_sec1 = v8:AddSection({
    Title = "Mirage Island / Full Moon",
    Open = true
})

local FullMoonStatus = v8_sec1:AddParagraph({
    Title = "Full Moon Status",
    Content = "Checking..."
})

local MirageIslandStatus = v8_sec1:AddParagraph({
...
local v8_sec2 = v8:AddSection({
    Title = "Mirage Island Features",
    Open = true
})

v8_sec2:AddToggle("AutoFindMirageIsland", {
...
v8_sec2:AddToggle("AutoTweenToMirageIsland", {
...
v8_sec2:AddToggle("AutoTweenToHighestPoint", {
...
v8_sec2:AddToggle("EspMirageIsland", {
...
v8_sec2:AddToggle("AutoCollectMirageChest", {
...
v8_sec2:AddToggle("ChangeTransparencySeeMirage", {
...
v8_sec2:AddToggle("AutoCollectGear", {
...
local v8_sec3 = v8:AddSection({
    Title = "Advanced Fruit Dealer",
    Open = true
})

v8_sec3:AddToggle("AutoTweenAdvancedFruitDealer", {
...
local v8_sec4 = v8:AddSection({
    Title = "Race V4 / Temple of Time",
    Open = true
})
...
local TiersStatus = v8_sec4:AddParagraph({
...
local v8_sec5 = v8:AddSection({
    Title = "Trials Quest V4",
    Open = true
})

v8_sec5:AddToggle("AutoPullLever", {
...
v8_sec5:AddToggle("AutoTeleporttoRaceDoors", {
...
v8_sec5:AddToggle("AutoCompleteTrials", {
...
v8_sec5:AddToggle("AutoKillPlayerAfterTrial", {
...
local v8_sec6 = v8:AddSection({
    Title = "Moon / Race Abilities",
    Open = true
})

v8_sec6:AddToggle("AutoLookAtMoon", {
...
v8_sec6:AddToggle("LookMoonAutoV3", {
...
local v8_sec7 = v8:AddSection({
    Title = "Upgrade Races V2 And V3",
    Open = true
})

v8_sec7:AddToggle("AutoUpgradeMink", {
...
v8_sec7:AddToggle("AutoUpgradeHuman", {
...
v8_sec7:AddToggle("AutoUpgradeAngel", {
...
v8_sec7:AddToggle("AutoUpgradeFishman", {
...
local v9_sec1 = v9:AddSection({
    Title = "Fruits Options",
    Open = true
})
...
local StockParagraph = v9_sec1:AddParagraph({
    Title = "Fruit Stock",
    Content = "Loading..."
})
...
local v9_sec2 = v9:AddSection({
    Title = "Fruit Auto Functions",
    Open = true
})

v9_sec2:AddToggle("AutoRandomFruit", {
...
v9_sec2:AddToggle("AutoDropFruit", {
...
v9_sec2:AddToggle("AutoStoreFruit", {
...
v9_sec2:AddToggle("AutoTweentoFruit", {
...
v9_sec2:AddToggle("AutoCollectFruit", {
...
local v9_sec3 = v9:AddSection({
    Title = "Fruit Shop Sniper",
    Open = true
})
...
v9_sec3:AddDropdown("SelectFruittoBuy", {
...
v9_sec3:AddToggle("AutoBuyFruitShopSniper", {
...
local v9_sec4 = v9:AddSection({
    Title = "Fruit Stock Checker",
    Open = true
})
...
v9_sec4:AddDropdown("SelectFruittoCheck", {
...
local FruitCheckResult = v9_sec4:AddParagraph({
    Title = "Fruit Status",
...
v9_sec4:AddToggle("AutoNotifywhenFruitinStock", {
...
local v10_sec1 = v10:AddSection({
    Title = "Raid Status",
    Open = true
})

local RaidTimerStatus = v10_sec1:AddParagraph({
    Title = "Raid Timer",
    Content = "Not in raid"
})

local RaidIslandStatus = v10_sec1:AddParagraph({
    Title = "Current Island",
    Content = "None"
})

local RaidMobsStatus = v10_sec1:AddParagraph({
...
v10_sec2:AddDropdown("SelectChip", {
    Title = "Select Chip",
    Values = RaidChipList,
...
v10_sec3:AddToggle("AutoBuyChipBeli", {
...
v10_sec3:AddToggle("AutoBuyChipFruit", {
...
v10_sec3:AddToggle("GetFruitInventoryBelow1M", {
...
local v10_sec4 = v10:AddSection({
    Title = "Raid Controls",
    Open = true
})

_G.AutoStartRaid = GetSetting("Raid_AutoStartRaid", false)
v10_sec4:AddToggle("AutoStartRaid", {
...
v10_sec5:AddToggle("AutoFarmDungeonNextFloor", {
...
local v10_sec6 = v10:AddSection({
    Title = "Teleport Floors",
    Open = true
})
...
local v10_sec7 = v10:AddSection({
    Title = "Awakening",
    Open = true
})

_G.AutoAwaken = GetSetting("Raid_AutoAwaken", false)
v10_sec7:AddToggle("AutoAwakening", {
...
local v10_sec8 = v10:AddSection({
    Title = "Law/Order Raid",
    Open = true
})
...
v10_sec8:AddToggle("AutoBuyLawChip", {
...
v10_sec8:AddToggle("AutoStartLawRaid", {
...
v10_sec8:AddToggle("AutoKillOrder", {
...
local v10_sec9 = v10:AddSection({
    Title = "Teleport",
    Open = true
})

_G.TpLab = GetSetting("Raid_TpLab", false)
v10_sec9:AddToggle("AutoTeleporttoLab", {
...
local v10_sec10 = v10:AddSection({
    Title = "Kill Aura",
    Open = true
})
...
v10_sec10:AddToggle("KillAura_2", {
    Title = "Kill Aura",
    Default = _G.KillAura,
    Callback = function(Value)
        _G.KillAura = Value
...
v10_sec10:AddInput("KillAuraRange", {
    Finished = true,
...
v10_sec10:AddInput("KillAuraDelays", {
    Finished = true,
...
local KillAuraCounter = 0
local KillAuraDisplay = v10_sec10:AddParagraph({
    Title = "Kill Aura Stats",
    Content = "Killed: 0"
})
...
v11_sec2:AddDropdown("SelectTravelling", {
...
v11_sec3:AddDropdown("SelectPortal", {
    Title = "Select Portal",
...
v11_sec4:AddDropdown("SelectNPCs", {
    Title = "Select NPCs",
    Values = NPCList,
    Default = false,
    Multi = false,
...
v11_sec4:AddToggle("AutoTweentoNPCs", {
...
local v13_sec1 = v13:AddSection({
    Title = "Stats Upgrade",
    Open = true
})

local StatsValue = 10
v13_sec1:AddSlider("StatsValue", {
    Title = "Stats Value",
    Min = 0,
    Max = 1000,
...
v13_sec1:AddToggle("AutoBloxFruit", {
...
v13_sec1:AddToggle("AutoDefense", {
    Title = "Auto Defense",
...
v13_sec2:AddToggle("ESPGearMirage", {
...
v13_sec2:AddToggle("ESPAdvancedDealer", {
...
v13_sec2:AddToggle("ESPHakiColor", {
...
local v14_sec1 = v14:AddSection({
    Title = "Purchase Melee V1",
    Open = true
})
...
v14_sec1:AddDropdown("ChooseMeleetoBuy", {
...
local v14_sec2 = v14:AddSection({
    Title = "Purchase Craft Sea Event Items",
    Open = true
})
...
local v14_sec3 = v14:AddSection({
    Title = "Purchase Haki, Soru, Geppo",
    Open = true
})
...
local v14_sec4 = v14:AddSection({
    Title = "Purchase Sword and Gun",
    Open = true
})
...
local v14_sec6 = v14:AddSection({
    Title = "Clan, Reset Stats",
    Open = true
})
...
local v15_sec2 = v15:AddSection({
    Title = "Player GUI / Others",
    Open = true
})
...
v15_sec2:AddToggle("DisableChatGUI", {
...
v15_sec2:AddToggle("DisableLeaderboardGUI", {
...
v15_sec2:AddToggle("UnlockAllPortalsWIP", {
...
local v15_sec3 = v15:AddSection({
    Title = "Graphics / Haki Stats",
    Open = true
})

local HakiStages = {"Stage 0", "Stage 1", "Stage 2", "Stage 3", "Stage 4", "Stage 5"}
v15_sec3:AddDropdown("SelectHakiStage", {
...
local v15_sec4 = v15:AddSection({
    Title = "Misc Graphics",
    Open = true
})

v15_sec4:AddToggle("RTXModeVisual", {
...
v15_sec5:AddDropdown("SelectTime", {
    Title = "Select Time",
    Values = TimeOptions,
    Default = "Day",
    Callback = function(Value)
...
v15_sec5:AddToggle("AutoSetTime", {
    Title = "Auto Set Time",
...
v15_sec5:AddToggle("IceWalkVisual", {
...
local v12_sec1 = v12:AddSection({
    Title = "Pvp, Aimbot, Movement",
    Open = true
})
...
local PlayerDropdown = v12_sec1:AddDropdown("SelectPlayers", {
...
v12_sec1:AddToggle("TeleporttoPlayer", {
...
v12_sec1:AddToggle("SpectateChoosePlayers", {
...
local v12_sec2 = v12:AddSection({
    Title = "Aimbot",
    Open = true
})

v12_sec2:AddToggle("AimbotCamLock", {
...
v12_sec2:AddToggle("AimbotSkills", {
    Title = "Aimbot Skills",
...
v12_sec3:AddToggle("SetWalkSpeed", {
    Title = "Set WalkSpeed",
...
v12_sec3:AddInput("WalkSpeedValue", {
    Finished = true,
...
v12_sec3:AddToggle("SetJumpPower", {
    Title = "Set JumpPower",
...
v12_sec3:AddInput("JumpPowerValue", {
    Finished = true,
...
local v12_sec4 = v12:AddSection({
    Title = "LocalPlayer Settings / Misc",
    Open = true
})

v12_sec4:AddToggle("InstanceMinkV3INF", {
...
v12_sec4:AddToggle("InstanceEnergyINF", {
...
v12_sec4:AddToggle("InstanceSoruINF", {
...
v12_sec4:AddToggle("InstanceObservationRangeINF", {
...
local v12_sec5 = v12:AddSection({
    Title = "Settings Combat / Aimbot Settings",
    Open = true
})

v12_sec5:AddToggle("IgnoreSameTeams", {
...
v12_sec5:AddToggle("AcceptAllies", {
    Title = "Accept Allies",
...
v12_sec6:AddDropdown("SelectTeam", {
    Title = "Select Team",
